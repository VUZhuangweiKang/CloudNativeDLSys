...
# create an operator
```shell
operator-sdk init dltdeploy-operator --domain com --repo=github.com/VUZhuangweiKang/CNDLSys/tree/main/src/dltdeploy-operator
operator-sdk create api --group docgroup --version=v1alpha1 --kind=DLTDeployment --resource=true --controller=true
