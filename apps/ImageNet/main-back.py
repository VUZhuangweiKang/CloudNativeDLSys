...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # val_dataset = ImageDataset(name='validation', transform=transform)
    ...
    #     return
    # else:
    #     train_dataset = ImageDataset(name='train', transform=transform)
    #     if args.distributed:
    ...
    train_dataset = ImageDataset(name='train')
    if args.distributed:
        train_sampler = torch.utils.data.distributed.DistributedSampler(train_dataset)
    else:
        train_sampler = None

    batch_sampler = create_block_sampler(train_dataset, shuffle=False, 
                                         num_workers=args.workers, 
                                         batch_size=args.batch_size, 
                                         drop_last=False)
    train_loader = DataLoader(train_dataset, num_workers=args.workers, pin_memory=True, batch_sampler=batch_sampler)
